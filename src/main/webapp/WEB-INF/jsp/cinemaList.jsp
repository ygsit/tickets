                ...
                <div class="row">
                    <form class="form-inline" action="${pageContext.request.contextPath}/cinema/findCinemaByPage">
                        ...
                        &nbsp;&nbsp;<a class="btn btn-default"
                                       href="${pageContext.request.contextPath}/cinema/findCinemaByPage" role="button"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="add_cinema_form" class="container-fluid" method="post"
                          action="${pageContext.request.contextPath}/cinema/cinemaAdd" onsubmit="return cinema_form__submit()">
                        <div class="row  form-group ">
                            <label class="col-sm-4">影院名称</label>
                            <input id="cinemaName" type="text" class="col-sm-8 " name="name" placeholder="请输入影院名" onblur="checkCinemaName()" required/>
                            <span class="col-sm-offset-4 col-sm-8"></span>
                        </div>
                        <div class="row  form-group ">
                            <label class="col-sm-4">影院地址</label>
                            <input type="text" class="col-sm-8 cinema_address" name="address" placeholder="请输入影院地址" onblur="cinema_address_to_check(event)" required/>
                            <span class="col-sm-offset-4 col-sm-8"></span>
                        </div>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="container-fluid" id="addCinemaForm" action="${pageContext.request.contextPath}/hall/hallAdd"  onsubmit="return addMovieHell()">
