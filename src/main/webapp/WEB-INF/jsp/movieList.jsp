...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/movieList.css" />
        ...
        <script src="${pageContext.request.contextPath}/static/js/movieList.js"></script>
        <!-- easyUI -->
            ...
            <div class="row index_body">
                <div class="col-md-2 body_left">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="${pageContext.request.contextPath}/movie/findMovieByPage" class="changeColor">电影管理</a></li>
                ...
                <div class="col-md-10 body_middle">
                    ...
                    <div class="container">
                        <div class="row">
                            <form class="form-inline" action="${pageContext.request.contextPath}/movie/findMovieByPage">
                                ...
                                &nbsp;&nbsp;<a class="btn btn-default" href="${pageContext.request.contextPath}/movie/findMovieByPage" role="button" onclick="clearValue()">清空</a>
                            </form>
                            <div style="float: right">
                                <a class="btn btn-primary" href="javascript:showRegister()" role="button">添加电影</a>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <table class="table table-hover table-bordered">
                                ...
                                <c:forEach var="movie" items="${pageBean.list}" varStatus="s">
                                    <tr>
                                        ...
                                        <td>${movie.actor}</td>
                                        <td class="movie_type">
                                            <c:if test="${fn:contains(movie.type,'1')}">
                                                科幻
                                            </c:if>
                                            <c:if test="${fn:contains(movie.type,'2')}">
                                                爱情
                                            </c:if>
                                            <c:if test="${fn:contains(movie.type,'3')}">
                                                动作
                                            </c:if>
                                            <c:if test="${fn:contains(movie.type,'4')}">
                                                喜剧
                                            </c:if>
                                            <c:if test="${fn:contains(movie.type,'5')}">
                                                悬疑
                                            </c:if>
                                            <c:if test="${fn:contains(movie.type,'6')}">
                                                剧情
                                            </c:if>
                                        </td>
                                        <td>${movie.time}</td>
                                        <td>${movie.createTime}</td>
                                        <td>
                                            <a class="btn btn-default" href="#" role="button" onclick="findById(${movie.mid})">修改</a>
                                            <a class="btn btn-default" href="#" role="button" onclick="del(${movie.mid})">删除</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination">
                                    ...
                                    <li>
                                        ...
                                        <a href="${pageContext.request.contextPath}/movie/findMovieByPage?currentPage=${pageBean.currentPage-1}&name=${selectName}" aria-label="Previous">
                                    ...
                                    <c:forEach begin="1" end="${pageBean.totalPage}" var="i">
                                        <c:if test="${pageBean.currentPage == i}">
                                            <li class="active"><a href="${pageContext.request.contextPath}/movie/findMovieByPage?currentPage=${i}&name=${selectName}">${i}</a></li>
                                        </c:if>
                                        <c:if test="${pageBean.currentPage != i}">
                                            <li><a href="${pageContext.request.contextPath}/movie/findMovieByPage?currentPage=${i}&name=${selectName}">${i}</a></li>
                                        </c:if>
                                    </c:forEach>
                                    ...
                                    <li>
                                        ...
                                        <a href="${pageContext.request.contextPath}/movie/findMovieByPage?currentPage=${pageBean.currentPage+1}&name=${selectName}" aria-label="Next">
